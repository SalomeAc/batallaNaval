...
public class Ship{
    ...
    //Lista de poscisiones para el EnemyBoard

    /**
     * Constructs a Ship object and initializes its list of ship positions.
     */
    public Ship() {
    ...
    /**
     * Gets the list of ship positions.
     *
     * @return the list of ship positions
     */
    ...
    /**
     * Sets the list of ship positions.
     *
     * @param shipsPositions the list of ship positions to set
     */
